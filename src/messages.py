...
STORY_DELETED = 'Story was successfully deleted'
NO_STORIES = 'Unfortunately, not one user from your subscriptions has not posted the story'
STORIES_FOUND = 'Stories was successfully found'
STORY_NOT_AVALIABLE = 'Story is already inaccessible'
