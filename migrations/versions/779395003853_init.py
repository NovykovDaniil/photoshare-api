...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('interlocutor_1', sa.String(), nullable=False),
    sa.Column('interlocutor_2', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['interlocutor_1'], ['users.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['interlocutor_2'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    op.create_table('message_chat_association',
...
def downgrade() -> None:
    ...
    op.drop_table('message_chat_association')
